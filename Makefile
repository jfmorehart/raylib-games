...
NEEDSCOMPILE = game/main.o engine/helpers.o entities/islands.o engine/routines.o entities/ships.o entities/bullets.o engine/vfx.o game/mapscene.o engine/filesystem.o game/mapshaders.o engine/UI.o game/shiploadouts.o engine/audio.o engine/text.o game/cutscene.o game/battlescene.o game/taskforce.o
